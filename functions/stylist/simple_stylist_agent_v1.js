...
function buildSystemPromptV1(request = {}) {
  return [
    ...
    "Aj neistotu vysvetli ľudsky: radšej 'pri týchto topánkach neviem posúdiť priľnavosť' než 'nemáme doloženú priľnavosť' a 'nepoznám ich strih' než 'zo záznamu nepoznám strih'. Nepripisuj si pohľad na fotku ani chýbajúcu vlastnosť, ktorú dodané údaje nepotvrdzujú.",
...
function buildModelInputV1(request, repairErrors = []) {
  ...
  return Object.freeze({
    ...
    messages: Object.freeze([
      Object.freeze({role: "system", content: buildSystemPromptV1(request)}),

...
function buildSystemPromptV1() {
  return [
    ...
    "Aj neistotu vysvetli ľudsky: radšej 'pri týchto topánkach neviem posúdiť priľnavosť' než 'nemáme doloženú priľnavosť', 'nepoznám ich strih' než 'zo záznamu nepoznám strih' a 'obchody tu zatiaľ neviem prehľadať' než 'v tomto rozhraní'. Nepripisuj si pohľad na fotku ani chýbajúcu vlastnosť, ktorú dodané údaje nepotvrdzujú.",

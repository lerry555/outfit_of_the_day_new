...
abstract final class OutfitReasonLibrary {
  ...
  static OutfitOuterComfortKind comfortKindForOuterNoun(String outerNoun) {
    ...
    if (o.contains('kabát') || o.contains('kabat') || o.contains('sako')) {
  ...
  static List<String> windSnippets() => ['fúka vietor', 'vietor je výrazný'];
  ...
  static List<String> stylingDarkLightTeeFirstSentence() => [
    'Čierne tričko je jednoduchý základ, ktorý sa ľahko kombinuje.',
  ...
  static List<String> stylingDarkLightLabelFirstSentence(String label) => [
    '$label je jednoduchý základ, ktorý sa ľahko kombinuje.',
  ...
  static List<String> shoesSneakers() => [
    'Tenisky sú praktické, keď budeš viac chodiť.',
    'Tenisky sú pohodlná voľba na bežný deň.',
    'Tenisky sú pohodlné na celý deň.',
    'Pri takomto dni je pohodlná obuv rozumná voľba.',
